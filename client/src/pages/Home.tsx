...
export default function Home() {
  ...
  function scheduleMobileAutoScroll() {
    ...
    const tick = () => {
      ...
      const target = document.elementFromPoint(pendingDrag.lastX, pendingDrag.lastY)?.closest<HTMLElement>("[data-proline-column]");
