...
Yeni tələb üzrə local İstehsalat sessiyası yoxlandı: header-də Settings düyməsi görünür, Settings modalında 12 rəng teması görünür, Excel şablonu/preview/export bölmələri department rolundan gizlədilir. Board isə yalnız öz sifarişlərini backend-dən alır; struktur sütun görünüşü üçün frontend bütün mərhələ sütunlarını render etməyə hazırdır.

23 Avq 2026 local preview (`https://3000-ikw7krtnpqczravivue9e-d56a3847.us3.manus.computer/`) İstehsalat sessiyası ilə yoxlanıldı. Board-da Sifarişlər, İstehsalat, Cilalama, Boyalama və Anbar sütun başlıqları/strukturu görünür; sifariş sayı 0 olduğuna görə yalnız öz mərhələsinin sifariş kartları göstərilə bilər. Status filterində artıq bütün beş mərhələ görünür. Header-də Settings mövcuddur.
